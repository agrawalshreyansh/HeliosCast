...
# =====================================================================
    ...
    if os.path.exists(p):
        st.image(p, width="stretch", caption="Sample test results showing high correlation.")
    else:
    ...
    if os.path.exists(p):
        st.image(p, width="stretch", caption="Comparison of two models trained on the same data.")
    else:
...
# =====================================================================
    ...
    if os.path.exists(workflow_path):
        st.image(workflow_path, width="stretch", caption="LangGraph 5-Node Agent Pipeline")
    else:
